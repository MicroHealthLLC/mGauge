...
<v-col v-else cols="8" class="text-center">
      ...
      <vue-speedometer class="row-4 mb-3" :value="newGauge.values[0].val_a" :maxValue=100 :width=700 :needleHeightRatio=.9
        needleColor="black" :paddingVertical=10 :ringWidth=110 :customSegmentStops='[0, 30, 45, 55, 70, 100]'
        :segmentColors='["tomato", "gold", "limegreen", "gold", "tomato"]' :customSegmentLabels='[
        {
        text: "Bad",
      ...
      <v-row>
        ...
        >
          <v-text-field
            ...
            :minlength="1"
            type="number"
            v-model.number="lastSavedGauge.values[0].val_a"
            placeholder="Enter value from 1-99"
            outlined
            class="mb-3"
          ></v-text-field>
        </v-col>
        ...
        <v-row class="mt-0">
         <v-col cols="12" class="pt-0">
          <v-textarea
              class="pt-0"
              v-model="lastSavedGauge.comments"
              color="teal"
            >
      ...
      <v-row>
        ...
        >
          <v-text-field
            ...
            :minlength="1"
            type="number"
            v-model.number="newGauge.values[0].val_a"
            placeholder="Enter value from 1-99"
            outlined
          ></v-text-field>
        </v-col>
